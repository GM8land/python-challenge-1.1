...
# print(f"Total: ${total}")
# Display the order recap dictionary with item details and subtotals
# print(order_recap)
...
# # Populate the order_recap dictionary WORKING
# for item in order_list:
#     item_name = item['Item name']
...
#     print(f"{item_name}{spaces_name} | ${item_price}{spaces_price} | {menu_item_quantity}")
...
# # Print the line for the receipt with subtotal
# print(f"{item_name}{spaces_name} | ${item_price}{spaces_price} | {menu_item_quantity} | Subtotal: ${subtotal}")
...
# # List comprehension to calculate price * quantity for each item in the order

# item_subtotal = [item['Price'] * item['Quantity'] for item in order_list]
# # Calculate the total price of the order using sum() on the list of item total prices
# total_price = sum(item_subtotal)
# print (item_subtotal)
